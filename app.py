...
connection = mysql.connector.connect(
    ...
    database=os.getenv('DB_NAME', 'opic_automatic')
)
...
@dataclass
class OpicFeedbackOutput:
    overall_feedback: str
    detailed_feedback: Dict[int, Optional[str]] 
...
def grading():
    ...
    models_paths = {
        "Task_Completion": "models/Task_Completion",
        "Accuracy": "models/Accuracy",
        "Appropriateness": "models/Appropriateness"
    }
